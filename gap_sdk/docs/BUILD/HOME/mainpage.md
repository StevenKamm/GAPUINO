GAP8 Manual                         {#mainpage}
======================

# Introduction of the GAP8 IoT application processor {#section0}
...
## GAP8 Micro-architecture {#section1}
...
![GAP8 Layout](./images/GAP8Layout.png)
...
## The Fabric Controller and The Cluster {#section3}
...
## Micro-DMA and cluster-DMA {#section5}
...
# Introduction to the GAP SDK {#section6}
...
# Installing the GAP SDK {#section7}

### Ubuntu 18.04 {#section8}
...
## Configure USB Port for GAPuino Evaluation Board and Gapoc board {#section9}
...
## Download and install the toolchain: {#section11}
...
## Install Python requirements {#section12}
...
## Getting the Autotiler {#section16}
...
# Compiling, running and debugging programs {#section18}
...
## Using the virtual platform {#section20}
...
## Using the flasher (Hyperflash) {#section21}
...
## Upgrading/Downgrading the SDK {#section24}
...
## What is in the gap8_sdk folder? {#section25}
